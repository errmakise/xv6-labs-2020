...
0000000080001a60 <forkret>:
{
  ...
  if (first) {
    ...
    80001a7c:	e687a783          	lw	a5,-408(a5) # 800088e0 <first.1667>
  ...
  usertrapret();
    ...
    80001a96:	e407a723          	sw	zero,-434(a5) # 800088e0 <first.1667>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  pid = nextpid;
    ...
    80001ac8:	e2078793          	addi	a5,a5,-480 # 800088e4 <nextpid>
...
0000000080001cf6 <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    80001d1a:	bda58593          	addi	a1,a1,-1062 # 800088f0 <initcode>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002a3a:	aa270713          	addi	a4,a4,-1374 # 800084d8 <states.1707+0x230>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002bc4:	93078793          	addi	a5,a5,-1744 # 800084f0 <syscalls>
    ...
    80002be8:	d4478793          	addi	a5,a5,-700 # 80008928 <syscall_names>
...
sys_exit(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002c46:	eda080e7          	jalr	-294(ra) # 80002b1c <argint>
    return -1;
  ...
  exit(n);
    ...
    80002c58:	4a6080e7          	jalr	1190(ra) # 800020fa <exit>
...
sys_getpid(void)
{
  ...
  return myproc()->pid;
    ...
    80002c74:	db8080e7          	jalr	-584(ra) # 80001a28 <myproc>
}
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002c8e:	162080e7          	jalr	354(ra) # 80001dec <fork>
}
...
sys_wait(void)
{
  ...
  if(argaddr(0, &p) < 0)
    ...
    80002cac:	e96080e7          	jalr	-362(ra) # 80002b3e <argaddr>
  ...
  return wait(p);
    ...
    80002cc0:	602080e7          	jalr	1538(ra) # 800022be <wait>
}
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002ce0:	e40080e7          	jalr	-448(ra) # 80002b1c <argint>
  ...
  addr = myproc()->sz;
    ...
    80002cf0:	d3c080e7          	jalr	-708(ra) # 80001a28 <myproc>
    80002cf4:	4524                	lw	s1,72(a0)
  if(growproc(n) < 0)
    80002cf6:	fdc42503          	lw	a0,-36(s0)
    80002cfa:	fffff097          	auipc	ra,0xfffff
    80002cfe:	07e080e7          	jalr	126(ra) # 80001d78 <growproc>
...
sys_sleep(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002d2e:	df2080e7          	jalr	-526(ra) # 80002b1c <argint>
    return -1;
  ...
  acquire(&tickslock);
    ...
    80002d44:	f1a080e7          	jalr	-230(ra) # 80000c5a <acquire>
  ticks0 = ticks;
  ...
  while(ticks - ticks0 < n){
    ...
    80002d6a:	cc2080e7          	jalr	-830(ra) # 80001a28 <myproc>
    ...
    80002d7a:	4ca080e7          	jalr	1226(ra) # 80002240 <sleep>
  while(ticks - ticks0 < n){
  ...
  release(&tickslock);
    ...
    80002d98:	f7a080e7          	jalr	-134(ra) # 80000d0e <release>
  return 0;
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
    ...
    80002dd4:	d4c080e7          	jalr	-692(ra) # 80002b1c <argint>
  ...
  return kill(pid);
    ...
    80002de8:	64c080e7          	jalr	1612(ra) # 80002430 <kill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002e0a:	e54080e7          	jalr	-428(ra) # 80000c5a <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    80002e22:	ef0080e7          	jalr	-272(ra) # 80000d0e <release>
  return xticks;
}
...
sys_trace(void)
{
  ...
  if(argint(0, &mask) < 0)
    80002e40:	fdc40593          	addi	a1,s0,-36
    80002e44:	4501                	li	a0,0
    80002e46:	00000097          	auipc	ra,0x0
    80002e4a:	cd6080e7          	jalr	-810(ra) # 80002b1c <argint>
    return -1;
    80002e4e:	57fd                	li	a5,-1
  if(argint(0, &mask) < 0)
    80002e50:	00054b63          	bltz	a0,80002e66 <sys_trace+0x30>
  
  myproc()->syscall_trace = mask;
    80002e54:	fdc42483          	lw	s1,-36(s0)
    80002e58:	fffff097          	auipc	ra,0xfffff
    80002e5c:	bd0080e7          	jalr	-1072(ra) # 80001a28 <myproc>
    80002e60:	16953423          	sd	s1,360(a0)
  return 0;
...
sys_sysinfo(void)
{
  ...
  if(argaddr(0, &addr) < 0)
    ...
    80002e84:	cbe080e7          	jalr	-834(ra) # 80002b3e <argaddr>
    80002e88:	87aa                	mv	a5,a0
    return -1;
    80002e8a:	557d                	li	a0,-1
  if(argaddr(0, &addr) < 0)
    80002e8c:	0207cd63          	bltz	a5,80002ec6 <sys_sysinfo+0x54>
  
  struct sysinfo sinfo;
  sinfo.freemem = count_free_mem(); // kalloc.c
    80002e90:	ffffe097          	auipc	ra,0xffffe
    80002e94:	cf0080e7          	jalr	-784(ra) # 80000b80 <count_free_mem>
    80002e98:	fca43c23          	sd	a0,-40(s0)
  sinfo.nproc = count_process(); // proc.c
    80002e9c:	fffff097          	auipc	ra,0xfffff
    80002ea0:	760080e7          	jalr	1888(ra) # 800025fc <count_process>
    80002ea4:	fea43023          	sd	a0,-32(s0)
  
  // copy sysinfo to user space
  if(copyout(myproc()->pagetable, addr, (char *)&sinfo, sizeof(sinfo)) < 0)
    80002ea8:	fffff097          	auipc	ra,0xfffff
    80002eac:	b80080e7          	jalr	-1152(ra) # 80001a28 <myproc>
    80002eb0:	46c1                	li	a3,16
    80002eb2:	fd840613          	addi	a2,s0,-40
    80002eb6:	fe843583          	ld	a1,-24(s0)
    80002eba:	6928                	ld	a0,80(a0)
    80002ebc:	fffff097          	auipc	ra,0xfffff
    80002ec0:	860080e7          	jalr	-1952(ra) # 8000171c <copyout>
    80002ec4:	957d                	srai	a0,a0,0x3f
    return -1;
  return 0;
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002ee2:	6d258593          	addi	a1,a1,1746 # 800085b0 <syscalls+0xc0>
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    80002f1e:	69ea0a13          	addi	s4,s4,1694 # 800085b8 <syscalls+0xc8>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  panic("bget: no buffers");
    ...
    80002ff0:	5d450513          	addi	a0,a0,1492 # 800085c0 <syscalls+0xd0>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80003080:	55c50513          	addi	a0,a0,1372 # 800085d8 <syscalls+0xe8>
...
brelse(struct buf *b)
{
  ...
  release(&bcache.lock);
    ...
    8000311e:	4c650513          	addi	a0,a0,1222 # 800085e0 <syscalls+0xf0>
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    80003212:	3da50513          	addi	a0,a0,986 # 800085e8 <syscalls+0xf8>
...
000000008000321e <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    800032d8:	32c50513          	addi	a0,a0,812 # 80008600 <syscalls+0x110>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    8000341e:	1fe50513          	addi	a0,a0,510 # 80008618 <syscalls+0x128>
...
000000008000342a <iget>:
{
  ...
  release(&icache.lock);
    ...
    800034da:	15a50513          	addi	a0,a0,346 # 80008630 <syscalls+0x140>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    8000355a:	0ea50513          	addi	a0,a0,234 # 80008640 <syscalls+0x150>
...
0000000080003566 <iinit>:
{
  ...
  initlock(&icache.lock, "icache");
    ...
    80003578:	0e458593          	addi	a1,a1,228 # 80008658 <syscalls+0x168>
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    800035a0:	0c490913          	addi	s2,s2,196 # 80008660 <syscalls+0x170>
...
00000000800035c6 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    8000363e:	02e50513          	addi	a0,a0,46 # 80008668 <syscalls+0x178>
...
000000008000375e <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003792:	ef250513          	addi	a0,a0,-270 # 80008680 <syscalls+0x190>
    ...
    80003814:	e7850513          	addi	a0,a0,-392 # 80008688 <syscalls+0x198>
...
0000000080003820 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80003860:	e3c50513          	addi	a0,a0,-452 # 80008698 <syscalls+0x1a8>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003c6a:	a3a50513          	addi	a0,a0,-1478 # 800086a0 <syscalls+0x1b0>
    80003c6e:	ffffd097          	auipc	ra,0xffffd
    80003c72:	8da080e7          	jalr	-1830(ra) # 80000548 <panic>
      panic("dirlookup read");
    80003c76:	00005517          	auipc	a0,0x5
    80003c7a:	a4250513          	addi	a0,a0,-1470 # 800086b8 <syscalls+0x1c8>
...
0000000080003e4c <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003ef2:	7da50513          	addi	a0,a0,2010 # 800086c8 <syscalls+0x1d8>
    80003ef6:	ffffc097          	auipc	ra,0xffffc
    80003efa:	652080e7          	jalr	1618(ra) # 80000548 <panic>
    panic("dirlink");
    80003efe:	00005517          	auipc	a0,0x5
    80003f02:	8e250513          	addi	a0,a0,-1822 # 800087e0 <syscalls+0x2f0>
...
0000000080004078 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80004096:	64658593          	addi	a1,a1,1606 # 800086d8 <syscalls+0x1e8>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    8000422c:	4b850513          	addi	a0,a0,1208 # 800086e0 <syscalls+0x1f0>
...
log_write(struct buf *b)
{
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    8000438a:	36a50513          	addi	a0,a0,874 # 800086f0 <syscalls+0x200>
    8000438e:	ffffc097          	auipc	ra,0xffffc
    80004392:	1ba080e7          	jalr	442(ra) # 80000548 <panic>
    panic("log_write outside of trans");
    80004396:	00004517          	auipc	a0,0x4
    8000439a:	37250513          	addi	a0,a0,882 # 80008708 <syscalls+0x218>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800043f2:	33a58593          	addi	a1,a1,826 # 80008728 <syscalls+0x238>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004514:	22858593          	addi	a1,a1,552 # 80008738 <syscalls+0x248>
...
filedup(struct file *f)
{
  ...
  return f;
    ...
    800045e0:	16450513          	addi	a0,a0,356 # 80008740 <syscalls+0x250>
...
fileclose(struct file *f)
{
  ...
  if(ff.type == FD_PIPE){
    ...
    80004678:	0d450513          	addi	a0,a0,212 # 80008748 <syscalls+0x258>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    800047d0:	f8c50513          	addi	a0,a0,-116 # 80008758 <syscalls+0x268>
    ...
    800047ec:	14078563          	beqz	a5,80004936 <filewrite+0x14e>
{
  ...
  return ret;
    ...
    80004912:	e5a50513          	addi	a0,a0,-422 # 80008768 <syscalls+0x278>
    ...
    8000492a:	e5250513          	addi	a0,a0,-430 # 80008778 <syscalls+0x288>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004d90:	9fc50513          	addi	a0,a0,-1540 # 80008788 <syscalls+0x298>
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    800051c2:	5ea50513          	addi	a0,a0,1514 # 800087a8 <syscalls+0x2b8>
    ...
    800051e8:	5d458593          	addi	a1,a1,1492 # 800087b8 <syscalls+0x2c8>
    ...
    80005202:	5c258593          	addi	a1,a1,1474 # 800087c0 <syscalls+0x2d0>
    ...
    80005218:	5b450513          	addi	a0,a0,1460 # 800087c8 <syscalls+0x2d8>
    8000521c:	ffffb097          	auipc	ra,0xffffb
    80005220:	32c080e7          	jalr	812(ra) # 80000548 <panic>
    panic("create: dirlink");
    80005224:	00003517          	auipc	a0,0x3
    80005228:	5b450513          	addi	a0,a0,1460 # 800087d8 <syscalls+0x2e8>
...
0000000080005538 <sys_unlink>:
{
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    8000559c:	22858593          	addi	a1,a1,552 # 800087c0 <syscalls+0x2d0>
  ...
  return 0;
    ...
    8000565c:	19050513          	addi	a0,a0,400 # 800087e8 <syscalls+0x2f8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    800056a8:	15c50513          	addi	a0,a0,348 # 80008800 <syscalls+0x310>
    800056ac:	ffffb097          	auipc	ra,0xffffb
    800056b0:	e9c080e7          	jalr	-356(ra) # 80000548 <panic>
    panic("unlink: writei");
    800056b4:	00003517          	auipc	a0,0x3
    800056b8:	16450513          	addi	a0,a0,356 # 80008818 <syscalls+0x328>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005e0c:	a2050513          	addi	a0,a0,-1504 # 80008828 <syscalls+0x338>
    80005e10:	ffffa097          	auipc	ra,0xffffa
    80005e14:	738080e7          	jalr	1848(ra) # 80000548 <panic>
    panic("virtio_disk_intr 2");
    80005e18:	00003517          	auipc	a0,0x3
    80005e1c:	a2850513          	addi	a0,a0,-1496 # 80008840 <syscalls+0x350>
...
0000000080005e28 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005e36:	a2658593          	addi	a1,a1,-1498 # 80008858 <syscalls+0x368>
...
virtio_disk_intr()
{
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    800062c8:	60450513          	addi	a0,a0,1540 # 800088c8 <syscalls+0x3d8>
