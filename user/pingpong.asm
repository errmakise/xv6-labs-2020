...
int main() {
   ...
   e:	8d650513          	addi	a0,a0,-1834 # 8e0 <p>
  12:	00000097          	auipc	ra,0x0
  16:	36c080e7          	jalr	876(ra) # 37e <pipe>
    int pid = fork();
  1a:	00000097          	auipc	ra,0x0
  1e:	34c080e7          	jalr	844(ra) # 366 <fork>

    if (pid > 0) {
  22:	04a04d63          	bgtz	a0,7c <main+0x7c>
        read(p[READ], buf, 4);
        printf("%d: received %s\n", getpid(), buf);
        exit(0);
    }
  ...
  26:	e95d                	bnez	a0,dc <main+0xdc>
        char buf[10];
        read(p[READ], buf, 4);
  28:	00001497          	auipc	s1,0x1
  2c:	8b848493          	addi	s1,s1,-1864 # 8e0 <p>
  30:	4611                	li	a2,4
  32:	fd040593          	addi	a1,s0,-48
  36:	4088                	lw	a0,0(s1)
  38:	00000097          	auipc	ra,0x0
  3c:	34e080e7          	jalr	846(ra) # 386 <read>
        printf("%d: received %s\n", getpid(), buf);
  40:	00000097          	auipc	ra,0x0
  44:	3ae080e7          	jalr	942(ra) # 3ee <getpid>
  48:	85aa                	mv	a1,a0
  4a:	fd040613          	addi	a2,s0,-48
  4e:	00001517          	auipc	a0,0x1
  52:	84250513          	addi	a0,a0,-1982 # 890 <malloc+0xec>
  56:	00000097          	auipc	ra,0x0
  5a:	690080e7          	jalr	1680(ra) # 6e6 <printf>
        write(p[WRITE], "pong", 4);
  5e:	4611                	li	a2,4
  60:	00001597          	auipc	a1,0x1
  64:	84858593          	addi	a1,a1,-1976 # 8a8 <malloc+0x104>
  68:	40c8                	lw	a0,4(s1)
  6a:	00000097          	auipc	ra,0x0
  6e:	324080e7          	jalr	804(ra) # 38e <write>
        exit(0);
  72:	4501                	li	a0,0
  74:	00000097          	auipc	ra,0x0
  78:	2fa080e7          	jalr	762(ra) # 36e <exit>
        write(p[WRITE], "ping", 4);
  7c:	00001497          	auipc	s1,0x1
  80:	86448493          	addi	s1,s1,-1948 # 8e0 <p>
  84:	4611                	li	a2,4
  86:	00001597          	auipc	a1,0x1
  8a:	80258593          	addi	a1,a1,-2046 # 888 <malloc+0xe4>
  8e:	40c8                	lw	a0,4(s1)
  90:	00000097          	auipc	ra,0x0
  94:	2fe080e7          	jalr	766(ra) # 38e <write>
        wait(&status);
  98:	fcc40513          	addi	a0,s0,-52
  9c:	00000097          	auipc	ra,0x0
  a0:	2da080e7          	jalr	730(ra) # 376 <wait>
        read(p[READ], buf, 4);
  a4:	4611                	li	a2,4
  a6:	fd040593          	addi	a1,s0,-48
  aa:	4088                	lw	a0,0(s1)
  ac:	00000097          	auipc	ra,0x0
  b0:	2da080e7          	jalr	730(ra) # 386 <read>
        printf("%d: received %s\n", getpid(), buf);
  b4:	00000097          	auipc	ra,0x0
  b8:	33a080e7          	jalr	826(ra) # 3ee <getpid>
  bc:	85aa                	mv	a1,a0
  be:	fd040613          	addi	a2,s0,-48
  c2:	00000517          	auipc	a0,0x0
  c6:	7ce50513          	addi	a0,a0,1998 # 890 <malloc+0xec>
  ca:	00000097          	auipc	ra,0x0
  ce:	61c080e7          	jalr	1564(ra) # 6e6 <printf>
        exit(0);
  d2:	4501                	li	a0,0
  d4:	00000097          	auipc	ra,0x0
  d8:	29a080e7          	jalr	666(ra) # 36e <exit>
    }

    else {
        fprintf(2, "fork error");
  dc:	00000597          	auipc	a1,0x0
  e0:	7d458593          	addi	a1,a1,2004 # 8b0 <malloc+0x10c>
  e4:	4509                	li	a0,2
  e6:	00000097          	auipc	ra,0x0
  ea:	5d2080e7          	jalr	1490(ra) # 6b8 <fprintf>
        exit(1);
  ee:	4505                	li	a0,1
...
free(void *ap)
{
 ...
 72a:	1c27b783          	ld	a5,450(a5) # 8e8 <freep>
 ...
 758:	00e6ea63          	bltu	a3,a4,76c <free+0x50>
{
 ...
 79a:	14f73923          	sd	a5,338(a4) # 8e8 <freep>
}
 79e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7cc:	12053503          	ld	a0,288(a0) # 8e8 <freep>
 ...
 7f4:	0f890913          	addi	s2,s2,248 # 8e8 <freep>
  if(p == (char*)-1)
 7f8:	5afd                	li	s5,-1
 7fa:	a88d                	j	86c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7fc:	00000797          	auipc	a5,0x0
 800:	0f478793          	addi	a5,a5,244 # 8f0 <base>
 804:	00000717          	auipc	a4,0x0
 808:	0ef73223          	sd	a5,228(a4) # 8e8 <freep>
 80c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 82e:	0aa73f23          	sd	a0,190(a4) # 8e8 <freep>
      return (void*)(p + 1);
